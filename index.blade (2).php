        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3 mb-4">
                <div class="program-card">
                    ...
                    <a href="{{ route('courses.show', $course->slug ?? 'scrum-master') }}" class="btn btn-outline-primary btn-sm">
                        View Program
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 mb-4">
                <div class="program-card">
                    ...
                    <a href="{{ route('courses.show', $course->slug ?? 'scrum-product-owner') }}" class="btn btn-outline-primary btn-sm">
                        View Program
                    </a>
                </div>
            </div>
